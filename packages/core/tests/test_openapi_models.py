"""Focused compatibility tests for evidence-aware core models."""

from __future__ import annotations

from dataclasses import replace

from repo_lint_core.canonical import semantic_finding_key, semantic_fingerprint, with_fingerprint
...
from repo_lint_core.render import diagnostic_dict, report_dict
...
def test_rule_metadata_defaults_preserve_existing_policy_constructors() -> None:
    rule = Rule(RuleId("example/rule"), 1, "warning", "Summary", "Why", "Bad", "Good")

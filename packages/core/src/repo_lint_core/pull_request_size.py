"""Deterministic pull-request size analysis over two Git revisions."""
...
class PullRequestFileSize:
    """One changed path and its size-policy classification."""
...
class PullRequestSize:
    """A complete pull-request size result."""
    ...
    def category_lines(self) -> dict[str, int]:
        """Return deterministic line totals by category."""
...
def is_test_path(path: str) -> bool:
    """Return whether a repository path follows a conventional test naming scheme."""
...
def analyze_pull_request_size(
    ...
    *,
    ...
    """Analyze additions and deletions, trusting attributes from the base revision."""
